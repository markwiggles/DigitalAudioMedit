...
namespace digaudconsole
    ...
    class MusicNote
        {
        //public enum NotePitch { Ab, A_, Bb, B_, C_, Db, D_, Eb, E_, F_, Gb, G_ }  // This enum is currently unused in the application.
        ...
        public MusicNote( double frequency, double durationInSamples )
            {
